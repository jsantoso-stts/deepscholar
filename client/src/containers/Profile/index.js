...
import './style.css';
import {Tabs, Tab, Pagination} from 'react-materialize';
  ...
  constructor(props) {
    ...
    this.state = {
      profile: {
        ...
        website: [{data: 'http://www.hshindo.com', source: 'Hiroyuki Shindo (2018-03-13)'}],
        otherids: [{data: 'SCOPUS AUTHOR ID: 56567565300', source: 'Scopus - Elsevier (2018-03-09)'}],
      ...
      affiliation: [
        {
          ...
          identifer: {
            ...
            othergrid: {
              ...
              wikidata: 'Q843253',
              wikipedia_url: [
{url: 'https://en.wikipedia.org/wiki/Nara_Institute_of_Science_and_Technology (preferred)'},
{url: 'https://en.wikipedia.org/wiki/Nara_Institute_of_Science_and_Technology'}
]
            }
          },
          createDate: {
...
{url: 'https://en.wikipedia.org/wiki/Nara_Institute_of_Science_and_Technology'}
  ...
  render() {
    const userInitial = this.state.profile.name.slice(0, 1);
                  ...
                  <div className="card-content m-t-30">
                    <div className="center">
                      <div className="user_bg">
                        ...
                        <div className="initial_flort">{userInitial}</div>
                      </div>
